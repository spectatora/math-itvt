...
/** libs/jquery-ui-1.8.2.custom.min.js **/
...
function(g,f){g=c('<button type="button"></button>').text(translate(g)).click(function(){f.apply(b.element[0],arguments)}).appendTo(e);c.fn.button&&g.button()});e.appendTo(b.uiDialog)}},_makeDraggable:function(){function a(f){return{position:f.position,offset:f.offset}}var b=this,d=b.options,e=c(document),g;b.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-close",handle:".ui-dialog-titlebar",containment:"document",start:function(f,h){g=d.height==="auto"?"auto":c(this).height();c(this).height(c(this).height()).addClass("ui-dialog-dragging");
...
/** libs/plugins/jquery.gettext.js **/
...
/** libs/plugins/jquery.json-2.2.min.js **/
...
/** libs/plugins/jquery.textboxList.js **/
...
/** libs/plugins/ui.spinner.min.js **/
